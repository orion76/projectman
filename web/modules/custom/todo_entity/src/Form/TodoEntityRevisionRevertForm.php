...
class TodoEntityRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\todo_entity\Entity\TodoEntityInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\todo_entity\Entity\TodoEntityInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\todo_entity\Entity\TodoEntityInterface
